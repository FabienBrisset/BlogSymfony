...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'blog', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/AngryProgrammers/BlogBundle/Entity'))), 'AngryProgrammers\\BlogBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('AngryProgrammersBlogBundle' => 'AngryProgrammers\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e8d302fceedd74c4c89c1fe629cdc2362f7c16876c242e7f1227031cd9cc6400');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('AngryProgrammers\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('AngryProgrammers\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('AngryProgrammers\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('AngryProgrammers\\BlogBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'AngryProgrammers\\BlogBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AngryProgrammers/BlogBundle/Resources/views'), 'AngryProgrammersBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ed84321c196c94b3b13c97a7f673561a77db4014');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AngryProgrammersBlogBundle' => 'AngryProgrammers\\BlogBundle\\AngryProgrammersBlogBundle',
            ...
            'secret' => 'ed84321c196c94b3b13c97a7f673561a77db4014',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ed84321c196c94b3b13c97a7f673561a77db4014',
            ...
            'fos_user.model.user.class' => 'AngryProgrammers\\BlogBundle\\Entity\\User',
